...
public sealed class MvcModuleScaffolder : EditorWindow
{
    ...
    private const string DefaultSceneStateRegistryFile = "Assets/Downloads/HotfixScripts/Modules/SceneStateRegistryModule.cs";
    ...
    private void DrawRegistryFileOptions()
    {
        ...
        controllerRegistryFile = DrawFileField("Controller注册文件", controllerRegistryFile, "cs");
        modelRegistryFile = DrawFileField("Model注册文件", modelRegistryFile, "cs");
        viewRegistryFile = DrawFileField("View注册文件", viewRegistryFile, "cs");
        sceneStateRegistryFile = DrawFileField("SceneState注册文件", sceneStateRegistryFile, "cs");
    }
    ...
    private string DrawFileField(string label, string currentValue, string extension)
    {
        using (new EditorGUILayout.HorizontalScope())
        {
            currentValue = EditorGUILayout.TextField(label, currentValue);
    ...
    private string CreateSceneStateFile(string sanitizedSceneStateName)
    {
        ...
        var content = $@"using JFramework.Unity;

namespace {namespaceName}
{{
    public class {className} : SceneState
    {{
    }}
}}
";
